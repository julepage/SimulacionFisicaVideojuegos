...
Particula::Particula(Vector3D pos, Vector3D vel, Vector3D acc, float d, float mass, float g): pose(pos.getX(), pos.getY(), pos.getZ()), velocidad(vel),
ac(acc), damping(d), masa(mass), gravedad(g)
{
